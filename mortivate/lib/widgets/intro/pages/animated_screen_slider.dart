...
//  PageController get controller => this.createState()._controller;
  ...
  const AnimatedIntroduction({
    ...
    this.containerBg = const Color.fromARGB(255, 0, 0, 0),
    ...
    this.footerBgColor = const Color.fromARGB(255, 0, 57, 104),
    this.footerBgColorII = const Color.fromARGB(255, 0, 104, 35),
